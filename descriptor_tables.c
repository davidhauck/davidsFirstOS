...
// points to the start of the gdt and its length
...
// COnatins one value for the idt
...
// let us access the addresses of the ASM ISR handlers.
extern void isr0 ();
extern void isr1 ();
extern void isr2 ();
extern void isr3 ();
